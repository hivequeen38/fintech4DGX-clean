...
'''
DEPRECATED, for new stuff go to mainDeltaFromToday()
'''
...
def main(run_date=None, input_comment=None, load_cache=True):
    ...
    #
    comment = '(Old Process) (Fixed seed)' + ' Rundate= ' + str(run_date) + ' ' + input_comment
    ...
    # NVDA_1d_predictions_test.csv
    #
    comment = '(Old Process) (Random seed)'  + ' Rundate= ' + str(run_date) + ' ' + input_comment

"""PLTR LightGBM GBDT param file.

Feature list mirrors PLTR_param.AAII_option_vol_ratio.selected_columns
(minus 'label') — already validated through Transformer SHAP tuning passes.

NOTE: PLTR IPO was 2021-09-30 → ~100 fewer training rows than NVDA/APP/INOD.

lgbm_reference      : Tier1 + defense sector + Tier3a options + Tier3b IV
...
lgbm_reference = {
    ...
    "comment":    "PLTR GBDT — Tier1 + defense sector + options + IV (backfill complete 2026-03-01)",
    ...
    "selected_columns": [
        ...
        "price_change_5",
        "price_change_15",
        # --- Tier 2: Defense / gov't IT sector ---
        "rs_ita",
        "rs_igv",
        "rs_ita_trend",
        "FDEFX",    # National Defense Consumption Expenditures & Gross Investment
        ...
        # --- Tier 3b: Implied Volatility (PLTR backfill complete) ---
        "iv_30d",
        "iv_skew_30d",
        "iv_term_ratio",
    ],
    ...
    # ── Calendar splits ───────────────────────────────────────────────
    "start_date":     "2021-09-30",   # IPO date
